...
{
    if (!_synchronizer) {
        _synchronizer = [QSCloudKitSynchronizer cloudKitPrivateSynchronizerWithContainerName:@"iCloud.com.synckit.SyncKitCoreDataExample" managedObjectContext:self.managedObjectContext];
    }
...
- (QSCloudKitSynchronizer *)sharedSynchronizer
{
    if (!_sharedSynchronizer) {
        _sharedSynchronizer = [QSCloudKitSynchronizer cloudKitSharedSynchronizerWithContainerName:@"iCloud.com.synckit.SyncKitCoreDataExample" objectModel:self.managedObjectModel];
    }
