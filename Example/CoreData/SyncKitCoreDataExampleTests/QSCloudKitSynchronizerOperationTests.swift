//
//  QSCloudKitSynchronizerOperationTests.swift
...
class QSCloudKitSynchronizerOperationTests: XCTestCase {
    
    var operation: QSCloudKitSynchronizerOperation!
    
    override func setUp() {
        super.setUp()
        
        operation = QSCloudKitSynchronizerOperation()
    }
