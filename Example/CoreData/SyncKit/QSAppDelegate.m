...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo
{
    ...
    NSLog(@"Silent Push Code Notification: %li", (long)pushCode);
...
//    NSDictionary *aps = userInfo[@"ap   s"];
//    NSString *alertMessage = aps[@"alert"];
//    [self synchronizer];
//    NSLog(@"Remote Notification received");
//
...
{
    if (!_synchronizer) {
        _synchronizer = [QSCloudKitSynchronizer cloudKitPrivateSynchronizerWithContainerName:@"iCloud.ch.jeko.SyncKit" managedObjectContext:self.managedObjectContext];
    }
...
- (QSCloudKitSynchronizer *)sharedSynchronizer
{
    if (!_sharedSynchronizer) {
        _sharedSynchronizer = [QSCloudKitSynchronizer cloudKitSharedSynchronizerWithContainerName:@"iCloud.ch.jeko.SyncKit" objectModel:self.managedObjectModel];
    }
