...
@interface QSAppDelegate () <QSCoreDataChangeManagerDelegate>
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"QSExample2" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"QSExample2.sqlite"];
    NSError *error = nil;
...
{
    if (!_synchronizer) {
        _synchronizer = [QSCloudKitSynchronizer cloudKitSynchronizerWithContainerName:@"your-iCloud-container-name" managedObjectContext:self.managedObjectContext changeManagerDelegate:self];
    }
